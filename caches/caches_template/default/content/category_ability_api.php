    ...
    <div class="section_d ">
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexbt imglistanimate">
                ...
                <li class=" w31 lib1p2">
                    <div class="imgbox centers">
                        <img class="wt50" src="<?php echo $li['thumb'];?>" alt="<?php echo $li['title'];?>">
                    </div>
                    <div class="font14 font400 color3F4552 mt3"><?php echo $li['content'];?></div>
                </li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            ...
            <ul class="flex flexbt centers imgrotatetp1 ">
                ...
                <li class="w31 lib1p2">
                   <div class="imgbox centers">
                    ...
                    <div class="font18 font400 color3F4552 opacity6 mt3"><?php echo $li['title'];?></div>
                </li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </ul>
