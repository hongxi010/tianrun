...
<div class="product">
    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt current">
            ...
            <div class="font30 font700 mb2 centers"><?php echo $s['catname'];?></div>
    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexwp flexbt ultype">
                ...
                <?php $n=1;if(is_array($event6)) foreach($event6 AS $e6) { ?>
                <li class="w31 flex flexjt  flexat height90 box_bg bgfff color00BE95 font20"><?php echo $e6['title'];?></li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </ul>
    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexwp flexbt font18">
                ...
                <?php $n=1;if(is_array($event6)) foreach($event6 AS $e6) { ?>
                <li class="w18 flex flexjt box_bg flexat height52 bgfff mb3">
                    <?php echo $e6['title'];?>
                </li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
