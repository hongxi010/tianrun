...
<div class="header">
   <div class="autowidth flex flexat flexbt">
       <a class="logo flex flexat" href="/"><h1 class="flex flexat"><img src="<?php echo CSS_PATH;?>web/images/logo.png" alt="天润"></h1><div class="daima colorfff"><p>股票代码</p><p>8888</p></div></a>
<div class="flex1 navFlex">
           <dl class="flex flexend headNav">
               <dd class="on"><a href="/">首页</a></dd>
           <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=242b66aec0321daa6eef3b398d2ca1fd&action=category&catid=34&order=listorder+ASC&return=datas\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = bc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {global $datas; $datas = $content_tag->category(array('catid'=>'34','order'=>'listorder ASC','limit'=>'20',));}?>
          ...
          <?php } elseif ($s[listorder]==2) { ?>       
               ...
               <dd><a href="<?php echo $s['url'];?>"><?php echo $s['catname'];?></a></dd>
