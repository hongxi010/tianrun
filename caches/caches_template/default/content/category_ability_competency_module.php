...
<div class="solution competencymodule">
        ...
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexbt imgrotatetp1">
                ...
                <li class="centers lib1p2 w24 bgfff">
                    ...
                    <div class="font24 font400 color01AF8A"><?php echo $li['title'];?></div>
                    <div class="font18 font400 color3F4552 opacity6">
    ...
    <div class="section_d  ">
        ...
        <div class="autowidth animationDH animateBt current">
            ...
            <img class="mb3" src="<?php echo $li['thumb'];?>" alt="<?php echo $li['title'];?>">
            ...
            <ul class="flex flexbt imglistanimate">
                ...
                <li class="centers lib1p2 w31">
                    <a class="color3F4552  " href="">
                        ...
                        <div class="font24 font400  mt3"><?php echo $li['title'];?></div>
                        <div class="font14 font400 color3F4552 opacity6 max2">
                            <?php echo $li['content'];?>
                        </div>
                    </a>
                </li>
