    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt">
            ...
            <ul class="flex flexwp flexbt  centers font18 imgrotatetp2">
                ...
                <li class="w31 lib1p2 mb3 bgF6F7F8">
                    <img class="w6rem" src="<?php echo $li['thumb'];?>" alt="<?php echo $li['title'];?>">
                    <div class="mt3 font700"><?php echo $li['title'];?></div>
                    <div class="mt1 opacity6"><?php echo $li['description'];?></div>
                </li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </ul>
        ...
        <div class="autowidth animationDH animateBt current">
            ...
            <div class="imgTextMod">
                <dl>
                    ...
                    <dd class="ddText">
                        <div class="font24"><?php echo $li['description'];?></div>
    ...
    <div class="section_d bgc">
        <div class="autowidth animationDH animateBt current">
            ...
            <div class="imgTextMod modStateTwo">
                <dl>
                    <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=1dc61fe68325e0dcb792e0b749442bd0&action=lists&catid=%24subs%5Bcatid%5D&num=1&order=listorder+ASC&moreinfo=1&return=list\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = bc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {global $list; $list = $content_tag->lists(array('catid'=>$subs[catid],'order'=>'listorder ASC','moreinfo'=>'1','limit'=>'1',));}?>
                    <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
                    <dt class="dtImg">
                        <img src="<?php echo $li['thumb'];?>" alt="<?php echo $li['title'];?>">
                    </dt>
                    ...
                    <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
                    <dd class="ddText">
                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=e10cab8dfb56d86631360358bfcd271a&action=lists&catid=%24subs%5Bcatid%5D&where=listorder%3E1&num=10&order=listorder+ASC&moreinfo=1&return=list\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = bc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {global $list; $list = $content_tag->lists(array('catid'=>$subs[catid],'where'=>'listorder>1','order'=>'listorder ASC','moreinfo'=>'1','limit'=>'10',));}?>
                        <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
                        <div class="font18"><?php echo $li['title'];?></div>
                        <div class="font14 opacity6 mb3">
    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt">
            ...
            <ul class="flex flexwp flexbt   font18 ultype ">
                ...
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
                <li class="w31 lib1p2 bgF6F7F8 mb3 flex flexjt flexat  ">
                    <div class="publicBtn">
                        <a class="btn2" href="">查看更多 <i class="iconfont"></i></a>
                    </div>
                </li>
            </ul>
            <?php $n++;}unset($n); ?>
    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt">
            ...
            <ul class="flex flexwp flexbt font18">
                ...
                <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
                <li class="w15 flex flexjt flexat height64 bgF6F7F8 mb3"><?php echo $li['title'];?></li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </ul>
