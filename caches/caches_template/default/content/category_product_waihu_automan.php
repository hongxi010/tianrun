...
<div class="product">
    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexwp flexbt  centers font18  imglistanimate">
                ...
                <li class=" w24 lib1p2 mb3 ">
                    ...
                    <div class="mt1 opacity6"><?php echo $li['content'];?></div>
                </li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
    ...
    <div class="section_d bgc">
        <div class="autowidth animationDH animateBt current">
            ...
            <div class="font32 font700 mb6 centers"><?php echo $s['catname'];?> </div>
            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=33cd9a0e0a5286bb24fc09f437bd0cb6&action=lists&catid=%24s%5Bcatid%5D&num=1&order=listorder+ASC&moreinfo=1&return=list\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = bc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {global $list; $list = $content_tag->lists(array('catid'=>$s[catid],'order'=>'listorder ASC','moreinfo'=>'1','limit'=>'1',));}?>
            <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
            <div class="imgcenter mb6">
                <img src="<?php echo $li['thumb'];?>" alt="<?php echo $li['title'];?>">
            </div>
            <?php $n++;}unset($n); ?>
            <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            ...
            <ul class="flex flexwp flexbt  font18 ">
                <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=ba61537ec44b5b4f619f1d0cf1bdefbb&action=lists&catid=%24s%5Bcatid%5D&where=listorder%3E1&num=50&order=listorder+ASC&moreinfo=1&return=list\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = bc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {global $list; $list = $content_tag->lists(array('catid'=>$s[catid],'where'=>'listorder>1','order'=>'listorder ASC','moreinfo'=>'1','limit'=>'50',));}?>
                <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
                <li class="w49 lib1p2 bgF6F7F8 mb3">
    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexwp flexbt font18">
                <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=c835b3d89a2c367cf558329702664ad8&action=lists&catid=%24subs%5Bcatid%5D&num=50&order=listorder+ASC&moreinfo=1&return=list\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = bc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {global $list; $list = $content_tag->lists(array('catid'=>$subs[catid],'order'=>'listorder ASC','moreinfo'=>'1','limit'=>'50',));}?>
                <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
                <li class="w18 flex flexjt flexat height64 bgF6F7F8 mb3"><?php echo $li['title'];?></li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </ul>
            <?php $n++;}unset($n); ?>
