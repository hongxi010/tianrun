        ...
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexbt centers imglistanimate">
                ...
                <li class=" w31 lib1p2">
                    ...
                    <div class="font16 font400 color3F4552 opacity6"><?php echo $li['description'];?></div>
                </li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
        ...
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexwp flexbt  centers font18 imgrotatetp2 ">
                ...
                <li class=" w31 lib1p2 mb3 ">
                    ...
                    <div class="mt1 font16 opacity6"><?php echo $li['description'];?></div>
                </li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </ul>
    ...
    <div class="section_d bgc">
        ...
        <div class="autowidth animationDH animateBt">
            ...
            <ul class="flex flexwp flexbt font18">
                ...
                <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
                <li class="w15 flex flexjt flexat height64 bgfff mb3"><?php echo $li['title'];?></li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </ul>
