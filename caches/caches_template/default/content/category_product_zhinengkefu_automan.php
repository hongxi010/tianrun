...
<div class="product">
        ...
        <div class="autowidth animationDH animateBt current">
            ...
            <ul class="flex flexwp flexbt  centers font18 imgrotatetp2 ">
                ...
                <li class=" w31 lib1p2 mb3 ">
                    <img class="w6rem" src="<?php echo $li['thumb'];?>" alt="<?php echo $li['title'];?>">
                    <div class="mt3 font18"><?php echo $li['title'];?></div>
    ...
    <div class="section_d">
        <div class="autowidth animationDH animateBt">
            ...
            <ul class="flex flexwp flexbt  centers font18 font700 imgrotatetp2 newTypeOne">
                ...
                <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
                    ...
                    <li class="w24 mb3  bg01AF8A boradius16 pt6 pb6">
                        <img  class="w6rem"  src="<?php echo $li['thumb'];?>" alt="<?php echo $li['title'];?>">
                        <div class="mt3 colorfff"><?php echo $li['title'];?></div>
                        <div class="mask">
                            <div class=" mt1 font18 colorfff font700"><?php echo $li['title'];?></div>
                            <div class="mt1 font14  colorfff"><?php echo $li['content'];?></div>
                   	 </div>
                    </li>
    ...
    <div class="section_d bgc">
        ...
        <div class="autowidth animationDH animateBt">
            ...
            <ul class="flex flexwp flexbt font18">
                ...
                <?php $n=1;if(is_array($list)) foreach($list AS $li) { ?>
                <li class="w15 flex flexjt flexat height64 box_bg bgfff mb3"><?php echo $li['title'];?></li>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </ul>
