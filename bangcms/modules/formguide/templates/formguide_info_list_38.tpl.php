...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
			...
			<th align="center">预约酒店</th>
			<th width='250' align="center">公司/团体名称</th>
...
?>   
	...
	<input type="checkbox" name="did[]" value="<?php echo $d['dataid']?>">
		...
		<?php
			if($_GET[formid]==110){
				$str_d=explode("/",$d['my_file']);
		?>
			<td><?php echo $str_d[8]?> </td>
		<?php
			}
		?>
